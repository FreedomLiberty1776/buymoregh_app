...
List<TableMigration> initialMigration = [
  ...
  TableMigration(
    ...
    fieldItems: [
      ...
      FieldItem(
        fieldName: 'contract_outstanding_balance',
        type: 'double',
        action: 'add',
        oldName: '',
      ),
      FieldItem(
        fieldName: 'contract_total_paid',
        type: 'double',
        action: 'add',
        oldName: '',
      ),
      FieldItem(
        fieldName: 'contract_payment_percentage',
        type: 'double',
        action: 'add',
        oldName: '',
      ),
...
/// Migration 8: Add customer_number to Contract table
List<TableMigration> migration8 = [
  TableMigration(
    table: 'Contract',
    migrationVersion: 8,
    fieldItems: [
      ...
      FieldItem(
        fieldName: 'configured_penalty_amount',
        type: 'double',
        action: 'add',
        oldName: '',
        defaultValue: 0,
      ...
      FieldItem(
        fieldName: 'applied_penalty_amount',
        type: 'double',
        action: 'add',
        oldName: '',
        defaultValue: 0,
      ...
      FieldItem(
        fieldName: 'total_amount_with_penalty',
        type: 'double',
        action: 'add',
        oldName: '',
        defaultValue: 0,
...
/// Migration 9: Add customer_phone to Contract table
List<TableMigration> migration9 = [
  TableMigration(
    table: 'Contract',
    migrationVersion: 9,
    fieldItems: [
