...
class ApiConfig {
  ...
  // Base URLs
  static final String _devBaseUrl =
      'http://$localhostIP:8000'; // Android emulator localhost
  static const String _prodBaseUrl = 'https://buymoregh.com';

  static String get baseUrl =>
      environment == 'development' ? _devBaseUrl : _prodBaseUrl;
  ...
  static String get passwordResetRequest =>
      '$baseUrl/api/auth/agent/password-reset/request/';
  static String get passwordResetVerify =>
      '$baseUrl/api/auth/agent/password-reset/verify/';
  static String get passwordResetConfirm =>
      '$baseUrl/api/auth/agent/password-reset/confirm/';
  ...
  static String paymentStatus(String reference) =>
      '$baseUrl/api/payments/$reference/status/';
